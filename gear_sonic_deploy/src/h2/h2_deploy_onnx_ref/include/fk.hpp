/**
 * @file fk.hpp
 * @brief Forward kinematics (FK) for the H2 robot, parsed from a MuJoCo XML model.
 *
 * RobotFK loads a MuJoCo MJCF XML file, extracts the
...
/**
 * @class RobotFK
 * @brief Forward kinematics solver for the H2 robot, initialised from a MuJoCo XML.
 */
class RobotFK
{
    public:
