...
try:
    from gr00t.control.main.teleop.run_g1_data_exporter import Gr00tDataCollector
    from gr00t.control.robot_model.instantiation.g1 import instantiate_g1_robot_model
    from gr00t.data.constants import RS_VIEW_CAMERA_HEIGHT, RS_VIEW_CAMERA_WIDTH
    from gr00t.data.exporter import Gr00tDataExporter
    from gr00t.data.utils import get_dataset_features
...
class MockROSEnvironment:
    ...
    def __enter__(self):
        self.patches = [
            ...
            patch(
                "gr00t.control.main.teleop.run_g1_data_exporter.KeyboardListenerSubscriber",
                return_value=self.keyboard_listener,
            ),
            patch(
                "gr00t.control.main.teleop.run_g1_data_exporter.ROSImgMsgSubscriber",
                return_value=self.img_subscriber,
            ),
            patch(
                "gr00t.control.main.teleop.run_g1_data_exporter.ROSMsgSubscriber",
