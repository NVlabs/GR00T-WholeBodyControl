...
from gr00t.control.main.constants import CONTROL_GOAL_TOPIC, KEYBOARD_INPUT_TOPIC, STATE_TOPIC_NAME
from gr00t.control.utils.ros_utils import ROSMsgPublisher, ROSMsgSubscriber
from gr00t.control.utils.term_color_constants import GREEN_BOLD, RESET, YELLOW_BOLD
from gr00t.data.viz.rerun_viz import RerunViz
...
def start_g1_control_loop():
    proc = subprocess.Popen(
        [
            "python3",
            "gr00t/control/main/teleop/run_g1_control_loop.py",
