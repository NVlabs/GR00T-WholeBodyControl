...
from gr00t.control.robot_model import RobotModel
from gr00t.control.robot_model.supplemental_info.g1.g1_supplemental_info import G1SupplementalInfo
...
def env_fixture():
    ...
    """
    from gr00t.control.visualization.meshcat_visualizer_env import MeshcatVisualizerEnv

    root_dir = pathlib.Path(__file__).parent.parent.parent.parent
    urdf_path = str(root_dir / "gr00t/control/robot_model/model_data/g1/g1_29dof_with_hand.urdf")
    asset_path = str(root_dir / "gr00t/control/robot_model/model_data/g1")
    robot_config = {
