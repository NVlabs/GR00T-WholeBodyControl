...
from gr00t.control.main.teleop.configs.configs import DeploymentConfig
from gr00t.control.utils.run_real_checklist import show_deployment_checklist
...
class G1Deployment:
    ...
    def __init__(self, config: DeploymentConfig):
        ...
        # Process directories
        self.gr00t_root = Path(__file__).resolve().parent.parent
    ...
    def _run_in_tmux(self, name, cmd, wait_time=2, pane_index=None):
        ...
        env_cmd = f"export GR00T_TMUX_SESSION={self.session_name}"
    ...
    def start_camera_sensor(self):
        ...
        cmd = [
            sys.executable,
            str(self.gr00t_root / "gr00t/control/sensor/composed_camera.py"),
            "--egoview_camera",
    ...
    def start_camera_viewer(self):
        ...
        cmd = [
            sys.executable,
            str(self.gr00t_root / "gr00t/control/main/teleop/run_camera_viewer.py"),
            "--camera_host",
    ...
    def start_sim_loop(self):
        ...
        cmd = [
            sys.executable,
            str(self.gr00t_root / "gr00t/control/main/teleop/run_sim_loop.py"),
            "--wbc_version",
    ...
    def start_control_loop(self):
        ...
        cmd = [
            sys.executable,
            str(self.gr00t_root / "gr00t/control/main/teleop/run_g1_control_loop.py"),
            "--wbc_version",
            self.config.wbc_version,
            "--wbc_model_path",
    ...
    def start_teleop(self):
        ...
        cmd = [
            sys.executable,
            str(self.gr00t_root / "gr00t/control/main/teleop/run_teleop_policy_loop.py"),
            "--body_control_device",
    ...
    def start_data_collection(self):
        ...
        cmd = [
            sys.executable,
            str(self.gr00t_root / "gr00t/control/main/teleop/run_g1_data_exporter.py"),
    ...
    def start_webcam_recording(self):
        ...
        cmd = [
            sys.executable,
            str(self.gr00t_root / "scripts/run_webcam_recorder.py"),
            "--output_dir",
