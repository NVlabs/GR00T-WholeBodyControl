...
from gr00t.control.policy.g1_gear_wbc_policy import G1GearWbcPolicy
from gr00t.control.policy.identity_policy import IdentityPolicy
from gr00t.control.policy.interpolation_policy import InterpolationPolicy
...
def get_wbc_policy(
    ...
    if robot_type == "g1":
        ...
        gear_wbc_config = str(gr00t_path / ".." / wbc_config["GEAR_WBC_CONFIG"])
