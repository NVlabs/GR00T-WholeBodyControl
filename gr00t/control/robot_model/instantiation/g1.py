...
from gr00t.control.robot_model.supplemental_info.g1.g1_supplemental_info import (
    ElbowPose,
    G1SupplementalInfo,
    WaistLocation,
)
...
def instantiate_g1_robot_model(
    ...
    """
    gr00t_root = Path(__file__).resolve().parent.parent.parent.parent.parent
    robot_model_config = {
        "asset_path": os.path.join(gr00t_root, "gr00t/control/robot_model/model_data/g1"),
        "urdf_path": os.path.join(
            gr00t_root, "gr00t/control/robot_model/model_data/g1/g1_29dof_with_hand.urdf"
        ),
    }
