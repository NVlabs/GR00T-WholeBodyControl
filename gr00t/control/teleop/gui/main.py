...
GR00T_TELEOP_DATA_ROOT = os.path.join(os.path.dirname(gr00t.__file__), "./external/teleop/data")
...
class MainWindow(QMainWindow):
    ...
    def test_vive(self, checked):
        ...
        if not checked:
            ...
            script = "python"
            args = [
                "gr00t/control/teleop/main/test_vive.py",
                "--keyword",
    ...
    def start_manus_server(self):
        ...
        script = "python"
        args = ["gr00t/control/teleop/device/manus.py", "--port", self.manus_port_input.text()]
    ...
    def test_manus_client(self, checked):
        if not checked:
            ...
            script = "python"
            args = [
                "gr00t/control/teleop/main/test_manus.py",
                "--port",
