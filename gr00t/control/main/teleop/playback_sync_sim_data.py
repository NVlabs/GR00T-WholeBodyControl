"""
A convenience script to playback random demonstrations using GR00T-WholeBodyControl controller from
...
Example:
    $ python gr00t/control/main/teleop/playback_sync_sim_data.py --dataset output/robocasa_datasets/
...
from gr00t.control.main.teleop.configs.configs import SyncSimPlaybackConfig
from gr00t.control.robot_model.instantiation import get_robot_type_and_model
from gr00t.control.utils.sync_sim_utils import (
    generate_frame,
    get_data_exporter,
    get_env,
    get_policies,
...
from gr00t.data.exporter import TypedLeRobotDataset
...
if __name__ == "__main__":
    ...
    node = rclpy.create_node("playback_gr00t_control")
