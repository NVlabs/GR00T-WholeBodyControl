...
from gr00t.control.envs.g1.sim.image_publish_utils import ImagePublishProcess
from gr00t.control.envs.g1.sim.metric_utils import check_contact, check_height
from gr00t.control.envs.g1.sim.sim_utilts import get_subtree_body_names
from gr00t.control.envs.g1.sim.unitree_sdk2py_bridge import ElasticBand, UnitreeSdk2Bridge

GR00T_ROOT = Path(__file__).resolve().parent.parent.parent.parent.parent.parent
...
class DefaultEnv:
    ...
    def __init__(
        ...
        if config["ROBOT_SCENE"] == "gr00t/control/robot_model/model_data/g1/scene_29dof.xml":
    ...
    def init_scene(self):
        ...
        self.mj_model = mujoco.MjModel.from_xml_path(
            str(pathlib.Path(GR00T_ROOT) / self.config["ROBOT_SCENE"])
        )
...
class CubeEnv(DefaultEnv):
    ...
    def __init__(
        ...
        config["ROBOT_SCENE"] = "gr00t/control/robot_model/model_data/g1/pnp_cube_43dof.xml"
...
class BoxEnv(DefaultEnv):
    ...
    def __init__(
        ...
        # Override the robot scene
        config = config.copy()  # Create a copy to avoid modifying the original
        config["ROBOT_SCENE"] = "gr00t/control/robot_model/model_data/g1/lift_box_43dof.xml"
...
class BottleEnv(DefaultEnv):
    ...
    def __init__(
        ...
        # Override the robot scene
        config = config.copy()  # Create a copy to avoid modifying the original
        config["ROBOT_SCENE"] = "gr00t/control/robot_model/model_data/g1/pnp_bottle_43dof.xml"
        camera_configs = {
            "egoview": {
                "height": 400,
                "width": 400,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="./gr00t/control/main/teleop/configs/g1_29dof_gear_wbc.yaml",
        help="config file",
    )
