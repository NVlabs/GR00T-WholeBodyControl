...
class Gr00tJointInfo:
    """
    Mapping from gr00t actuated joint names to robocasa joint names.
    """
...
class Gr00tObsActionConverter:
    ...
    def _get_actuator_mapping(self) -> Dict[str, List[int]]:
        """Get mapping from gr00t actuatored joint order to robocasa actuatored joint order for whole body."""
        return {
            part_name: [
