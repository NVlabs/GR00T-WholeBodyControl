...
from gr00t.control.envs.robocasa.utils.controller_utils import update_robosuite_controller_configs
from gr00t.control.envs.robocasa.utils.robocasa_env import (  # noqa: F401
...
from gr00t.control.utils.n1_utils import (
...
def create_gym_sync_env_class(env, robot, robot_alias, wbc_version):
    ...
    current_module = sys.modules["gr00t.control.envs.robocasa.sync_env"]
