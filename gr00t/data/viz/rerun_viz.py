...
if __name__ == "__main__":
    ...
    if args.use_rs:
        ...
        from gr00t.control.sensor.realsense import RealSenseClientSensor

        sensor = RealSenseClientSensor()
    elif args.use_zed:
        image_keys = ["left_image", "right_image"]
        from gr00t.control.sensor.zed import ZEDClientSensor

        sensor = ZEDClientSensor()
    else:
        from gr00t.control.sensor.dummy import DummySensor
