...
export LD_LIBRARY_PATH=$GR00T_DIR/gr00t/control/teleop/device/SDKClient_Linux/ManusSDK/lib:$LD_LIBRARY_PATH

# CUDA support
export LD_LIBRARY_PATH=/usr/lib/x86_64-linux-gnu:/usr/lib:/lib/x86_64-linux-gnu:/lib64:/lib:$LD_LIBRARY_PATH 

# gr00t aliases
alias dg="python $GR00T_DIR/scripts/deploy_g1.py"
alias rsl="python $GR00T_DIR/gr00t/control/main/teleop/run_sim_loop.py"
alias rgcl="python $GR00T_DIR/gr00t/control/main/teleop/run_g1_control_loop.py"
alias rtpl="python $GR00T_DIR/gr00t/control/main/teleop/run_teleop_policy_loop.py"
alias tgcl="pytest $GR00T_DIR/tests/control/main/teleop/test_g1_control_loop.py -s"
